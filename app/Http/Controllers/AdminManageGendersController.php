...
class AdminManageGendersController extends Controller
{
    ...
    {
        $gender = \App\Gender::all();
        $user = \Illuminate\Support\Facades\Auth::user();
        $this->check_notification($user);
        $this->check_messages($user);
        return view('Admin.ManageGenders.view')->with('gender',$gender)->with('shown',$this->shown)->with('total_message',$this->total_messages)
    ...
    {
        $gender = \App\Gender::find($id);
        $user = \Illuminate\Support\Facades\Auth::user();
     
        $this->check_notification($user);
        $this->check_messages($user);

        return view('Admin.ManageGenders.edit')->with('gender',$gender)->with('shown',$this->shown)->with('total_message',$this->total_messages)
            ->with('data',$this->user_data)->with('time',$this->time)->with('ids',$this->ids)->with('user',$user);
    ...
    public function update(Request $request, $id)
    {
        ...
        $gender->gender_type = $request->gender_type;
