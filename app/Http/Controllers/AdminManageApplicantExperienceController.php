...
class AdminManageApplicantExperienceController extends Controller
{
    private $shown = false;
    ...
    {
        $applicants = \App\User::where('user_type_id','=',2)->get();
        $user = \Illuminate\Support\Facades\Auth::user();
        $this->check_notification($user);
        $this->check_messages($user);
        return view('Admin.ManageApplicantExperience.view')->with('applicants',$applicants)->with('shown',$this->shown)->with('total_message',$this->total_messages)
