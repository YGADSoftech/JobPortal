...
class AdminManageEmployerJobController extends Controller
{ private $shown = false;
    ...
    {
        $employers = \App\User::where('user_type_id','=',3)->get();
        $user = \Illuminate\Support\Facades\Auth::user();
        $this->check_notification($user);
        $this->check_messages($user);
        return view('Admin.ManageEmployerJob.view')->with('employers',$employers)->with('shown',$this->shown)->with('total_message',$this->total_messages)
