...
class AdminManageContriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Admin.ManageContries.view')->with('country',$country)->with('shown',$this->shown)->with('total_message',$this->total_messages)
    ...
    public function create()
    {
        ...
        $this->check_notification($user);
        $this->check_messages($user);
        return view('Admin.ManageContries.create')->with('shown',$this->shown)->with('total_message',$this->total_messages)
            ->with('data',$this->user_data)->with('time',$this->time)->with('ids',$this->ids)->with('user',$user);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.ManageContries.edit')->with('country',$country)->with('shown',$this->shown)->with('total_message',$this->total_messages)
            ->with('data',$this->user_data)->with('time',$this->time)->with('ids',$this->ids)->with('user',$user);
    ...
    public function update(Request $request, $id)
    {
        ...
        $countries->country_name = $request->country;
