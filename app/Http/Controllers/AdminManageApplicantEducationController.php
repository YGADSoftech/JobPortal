...
class AdminManageApplicantEducationController extends Controller
{
    private $shown = false;
    ...
    public function index()
    {
        ...
        return view('Admin.ManageApplicantEducation.view')->with('applicants',$applicants)->with('shown',$this->shown)->with('total_message',$this->total_messages)
