                        ...
                        @for($i=0;$i<count($ids);$i++)
                            <li>
                                <a href="{{route('showmessagebox',[$ids[$i]])}}">
                                    <span class="photo"><img alt="avatar" src="{{asset('Images/profile')}}/{{\App\User::find($ids[$i])->profile_img}}"></span>
                                    <span class="subject">
                            ...
                            @if($no->is_seen == 0)
                                ...
                                <li>
                                    <a href="{{route('status',$no->job->id?$no->job->id:'')}}">
                                        ...
                                        <h5 style="display:inline-block;">{{$no->job->title . " Posted"}}</h5>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="{{ route('viewApplicantProfile')}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
