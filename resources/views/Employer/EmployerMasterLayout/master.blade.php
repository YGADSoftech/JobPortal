                    ...
                    <!-- Message -->
                        ...
                        @foreach ($noti as $no)
                            @if($no->is_seen == 0)
                                ...
                                <li>
                                    <a href="{{route('status',$no->job->id)}}">
                                        <span class="label label-danger"><i class="fa fa-bolt"></i></span>
                                        <h5 style="display:inline-block;">Applicant Applied For <b>{{$no->job->title}}</b></h5>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="{{ route('viewEmployerProfile')}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
