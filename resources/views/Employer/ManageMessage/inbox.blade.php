...
@section('styling')
    ...
    <style>
        ...
        .inbox_people {
            ...
            overflow: hidden;
            width: auto; border-right:1px solid #c4c4c4;
        }
        .inbox_msg {
        ...
        .recent_heading {margin: 0 auto; width:40%;}
        .srch_bar {
            ...
            <div class="inbox_msg">
                ...
                <div class="inbox_chat">
                    @for($i=0;$i<count($msgids);$i++)
                        <a href="{{route('showmessagebox',[$msgids[$i]])}}"><div class="chat_list">
                                <div class="chat_people">
                                    <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                                    <div class="chat_ib">
                                        <h5>{{\App\User::find($msgids[$i])->user_name}}<span class="chat_date">{{$msgtimes[$i] . ' ' . $msgdate[$i]}}</span></h5>
