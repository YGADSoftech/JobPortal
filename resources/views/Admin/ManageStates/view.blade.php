        ...
        <div class="page-wrapper" style="min-height: 542px;">
            ...
            <div class="row page-titles">
                <div class="align-self-center">
                    <h3 class="text-primary text-center">View States</h3> </div>
                                    ...
                                    <table class="table table-hover ">
                                        ...
                                        @foreach($state as $s)
                                            <tr>
                                                    ...
                                                    <th>{{ $s->country->country_name  }}</th>
                                                    <th>{{ $s->state_name  }}</th>
                                                <th>
                                                <div class="button-container">
                                                        <form action="{{ route('States.edit',$s->id) }}" method="get">
                                                            <div>
                                                                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-edit" title="Edit"></span></button>
                                                            </div>
                                                        </form>
                                                        <form action="{{ route('States.destroy' ,$s->id) }}" method="POST">
                                                            <div>
                                                                {{ method_field('DELETE') }}
                                                                {{csrf_field()}}
