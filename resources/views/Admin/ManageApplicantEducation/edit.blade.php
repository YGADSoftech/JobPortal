...
@section('mainbody')
    ...
    <div class="container bootstrap snippet text-center">
        <h1 class="text-primary"><span></span> Update Job Type</h1>
        <hr>
        <div class="row">
                <form class="form-horizontal" role="form" action="{{route('JobType.update',['id'=>$jobtype->id])}}" method="POST"  >
                    {{ csrf_field() }}
                    @method('put')
                    ...
                    <div class="col-md-9 personal-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="jobtype" id="jobtype" placeholder="Job Type" value="{{$jobtype->job_type}}">
                            </div>
                        </div>
