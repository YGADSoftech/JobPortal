        ...
        <div class="page-wrapper" style="min-height: 542px;">
            ...
            <div class="row page-titles">
                <div class="align-self-center">
                    <h3 class="text-primary text-center">View Skills</h3> </div>
                                        ...
                                        @foreach($skillset as $ss)
                                            <tr>
                                                ...
                                                <div class="button-container">
                                                        <form action="{{ route('SkillSet.edit',$ss->id) }}" method="get">
                                                            <div>
                                                                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-edit" title="Edit"></span></button>
                                                            </div>
                                                        </form>
                                                        <form action="{{ route('SkillSet.destroy' ,$ss->id) }}" method="POST">
                                                            <div>
                                                                {{ method_field('DELETE') }}
                                                                {{csrf_field()}}
