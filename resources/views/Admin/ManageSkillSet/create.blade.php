...
@section('mainbody')
    ...
    <div class="container bootstrap snippet text-center">
        <h1 class="text-primary"><span ></span> Create Skill</h1>
        <hr>
        <div class="row">
        <form class="form-horizontal" role="form" action="{{route('SkillSet.store')}}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="col-md-9 personal-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="skill" placeholder="Skill Names" id="skill">
                            </div>
                        </div>
