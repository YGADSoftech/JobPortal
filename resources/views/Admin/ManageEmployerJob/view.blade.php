                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <tr> 
                                    <th Colspan = "7" class = "text-center">Jobs</th> 
                                    </tr>
                                    
                                    <tr>
                                    <th >Employer</th><th>Job Title</th><th>Company Name</th><th>Address</th>
                                    </tr>
                                    
                                    
                                        @foreach($employers as $em)
                                            @foreach($em->employer_profile->company_info  as $com)
                                                @foreach($com->employer_job as $job)
                                        <tr>
                                        
                                        <td><a href="{{route('Users.show',$em->id)}}">{{$em->user_name}}</a></td>
                                        <td><a href="{{route('viewjob',['id'=>$job->id])}}">{{$job->title}}</a> </td>
                                        <td><a href="{{$com->company_url}}">{{$com->company_info	}}</a> </td>
                                        <td>{{$com->address}}</td>
                                        </tr>
                                        @endforeach
                                        @endforeach
