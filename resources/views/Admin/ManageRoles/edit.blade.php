...
@section('mainbody')
    ...
    <div class="container bootstrap snippet text-center">
        <h1 class="text-primary"><span></span> Update Role</h1>
        <hr>
        <div class="row">
                <form class="form-horizontal" role="form" action="{{route('Roles.update',['id'=>$role->id])}}" method="POST"  enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @method('put')
                    ...
                    <div class="col-md-9 personal-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="role_name" placeholder="Role" id="role_name" value="{{$role->role_name}}">
                            </div>
                        </div>
