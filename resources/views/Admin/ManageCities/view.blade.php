        ...
        <div class="page-wrapper" style="min-height: 542px;">
            ...
            <div class="row page-titles">
                <div class="align-self-center">
                    <h3 class="text-primary text-center">View City</h3> </div>
                                    ...
                                    <table class="table table-hover ">
                                        ...
                                        @foreach($city as $c)
                                            <tr>
                                                    ...
                                                    <th>{{ $c->state->country->country_name  }}</th>
                                                    <th>{{ $c->state->state_name  }}</th>
                                                    <th>{{ $c->city_name  }}</th>
                                                <th>
                                                <div class="button-container">
                                                        <form action="{{ route('Cities.edit',$c->id) }}" method="get">
                                                            <div>
