...
@section('mainbody')
    ...
    <div class="container bootstrap snippet text-center">
        <h1 class="text-primary"><span></span> Update Gender</h1>
        <hr>
        <div class="row">
                <form class="form-horizontal" role="form" action="{{route('Genders.update',['id'=>$gender->id])}}" method="POST"  >
                    {{ csrf_field() }}
                    @method('put')
                    ...
                    <div class="col-md-9 personal-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="gender_type" placeholder="gender" id="gender_type" value="{{$gender->gender_type}}">
                            </div>
                        </div>
