...
@section('mainbody')
    ...
    <div class="container bootstrap snippet text-center">
        <h1 class="text-primary"><span></span> Update Zip Code</h1>
        <hr>
        <div class="row">
                <form class="form-horizontal" role="form" action="{{route('ZipCodes.update',['id'=>$zip->id])}}" method="POST"  >
                    {{ csrf_field() }}
                    @method('put')
                    ...
                    <div class="col-md-9 personal-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="zip" id="zip" placeholder="ZipCode" value="{{$zip->zip_code}}">
                            </div>
                        </div>
